...
import com.cin.cinpicturebackend.model.enums.SpaceRoleEnum;
import com.cin.cinpicturebackend.model.enums.SpaceTypeEnum;
    ...
    public long addSpace(SpaceAddRequest spaceAddRequest, User loginUser) {
        ...
        synchronized (lock) {
            Long newSpaceId = transactionTemplate.execute(status -> {
                boolean exists = this.lambdaQuery().eq(Space::getUserId, id).eq(Space::getSpaceType,space.getSpaceType()).exists();
